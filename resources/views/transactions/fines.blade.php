{{--
    ...
    This page provides the interface for librarians to manage library fines.
    It uses the FineManagement Livewire component for:
    - Viewing unpaid and paid fines
    - Recording payments (full or partial)
    - Waiving fines (admin only)
    - Viewing fine calculation breakdowns

    @see App\Http\Controllers\TransactionController::fineIndex()
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        View and manage library fines, record payments, and track collections
                    </p>
                </div>
        ...
        <div class="mb-6 bg-primary-50 border border-primary-200 rounded-lg p-4">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-primary-800">Fine Policy</h3>
                    <div class="mt-2 text-sm text-primary-700">
                        <p>
                            <strong>Fine Rate:</strong> {{ $finePolicy['currency'] }}{{ number_format($finePolicy['fine_per_day'], 2) }} per day after {{ $finePolicy['grace_period'] }} day grace period.
                        </p>
                        <p class="mt-1 text-xs">
                            Formula: (Days Overdue - Grace Period) × Fine per Day = Total Fine
                        </p>
                    </div>
                </div>
            </div>
        ...
        {{-- Livewire Fine Management Component --}}
        <livewire:fine-management />
    </div>
</div>
@endsection
