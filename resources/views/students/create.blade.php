{{--
    ...
    This page displays a form for registering a new student.
    The form includes all required and optional student fields.
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
                ...
                <ol class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-4 text-sm font-medium text-gray-500">Add Student</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <p class="mt-1 text-sm text-gray-500">
                Enter the student's information to register them in the library system.
            </p>
        </div>
        ...
        <form action="{{ route('students.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('students.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                    Cancel
                </a>
